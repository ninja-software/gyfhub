...
type Message struct {
	...
	GifURL    string    `db:"gif_url" boil:"gif_url" json:"gifURL" toml:"gifURL" yaml:"gifURL"`
...
var MessageWhere = struct {
	...
	PosterID:  whereHelperstring{field: "\"messages\".\"poster_id\""},
	GifURL:    whereHelperstring{field: "\"messages\".\"gif_url\""},
...
var (
	messageAllColumns            = []string{"id", "poster_id", "gif_url", "deleted_at", "updated_at", "created_at"}
	messageColumnsWithoutDefault = []string{"poster_id", "gif_url", "deleted_at"}
...
func (o *Message) Poster(mods ...qm.QueryMod) userQuery {
...
func (messageL) LoadPoster(e boil.Executor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
	...
	if singular {
		...
		foreign.R.PosterMessages = append(foreign.R.PosterMessages, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.PosterID == foreign.ID {
				...
				foreign.R.PosterMessages = append(foreign.R.PosterMessages, local)
				break
			}
		}
	}
...
// SetPoster of the message to the related item.
// Sets o.R.Poster to related.
// Adds o to related.R.PosterMessages.
func (o *Message) SetPoster(exec boil.Executor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			PosterMessages: MessageSlice{o},
		}
	} else {
		related.R.PosterMessages = append(related.R.PosterMessages, o)
	}
